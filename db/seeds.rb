...
r2 = Role.create({ name: 'Seller', description: 'Can read and update rekords' })
r3 = Role.create({ name: 'Admin', description: 'Can perform any CRUD operation on any resource' })

u1 = User.create({ name: 'Sally-user', email: 'sally@example.com', password: '11111111', password_confirmation: '11111111', role_id: r1.id })
